...
export const PERMISSIONS = {
  ...
  VIEW_MEMORIZATION_RECORD: "VIEW_MEMORIZATION_RECORD",
  UPDATE_MEMORIZATION_RECORD: "UPDATE_MEMORIZATION_RECORD",
  VOID_MEMORIZATION_RECORD: "VOID_MEMORIZATION_RECORD",
  VIEW_ACADEMIC_DASHBOARD: "VIEW_ACADEMIC_DASHBOARD",
...
const ROLE_PERMISSIONS: Record<RoleCode, ReadonlySet<Permission>> = {
  ADMIN: new Set([
    ...
    PERMISSIONS.VIEW_MEMORIZATION_RECORD,
    PERMISSIONS.GENERATE_REPORT,
  ]),
  HEAD: new Set([
    PERMISSIONS.VIEW_ACADEMIC_AUDIT,
    PERMISSIONS.VIEW_ACADEMIC_DASHBOARD,
    PERMISSIONS.VIEW_MEMORIZATION_RECORD,
    PERMISSIONS.UPDATE_MEMORIZATION_RECORD,
    PERMISSIONS.VOID_MEMORIZATION_RECORD,
  ...
  TEACHER: new Set([
    PERMISSIONS.CREATE_MEMORIZATION_RECORD,
    PERMISSIONS.VIEW_MEMORIZATION_RECORD,
    PERMISSIONS.UPDATE_MEMORIZATION_RECORD,
  ]),
};
