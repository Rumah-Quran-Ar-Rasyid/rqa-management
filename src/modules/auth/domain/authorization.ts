...
export const PERMISSIONS = {
  ...
  VIEW_HALAQAH_MEMBERSHIP: "VIEW_HALAQAH_MEMBERSHIP",
  MANAGE_HALAQAH_MEMBERSHIP: "MANAGE_HALAQAH_MEMBERSHIP",
  CREATE_MEMORIZATION_RECORD: "CREATE_MEMORIZATION_RECORD",
} as const;
...
const ROLE_PERMISSIONS: Record<RoleCode, ReadonlySet<Permission>> = {
  ADMIN: new Set([
    ...
    PERMISSIONS.MANAGE_HALAQAH_MEMBERSHIP,
  ]),
  HEAD: new Set([
    ...
    PERMISSIONS.VIEW_HALAQAH_MEMBERSHIP,
  ]),
  TEACHER: new Set([PERMISSIONS.CREATE_MEMORIZATION_RECORD]),
};
